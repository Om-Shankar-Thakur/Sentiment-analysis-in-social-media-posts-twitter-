...
def test_logistic_regression(test_x, test_y, freqs, theta, predict_tweet=predict_tweet):
    ...
    for tweet in test_x:
        ...
        if y_pred > 0.5:
            # Append 1.0 to the list if prediction is greater than 0.5
            y_hat.append(1)
        else:
            # Append 0 to the list if prediction is less than or equal to 0.5
            y_hat.append(0)
    
    # Convert both y_hat and test_y to one-dimensional arrays
